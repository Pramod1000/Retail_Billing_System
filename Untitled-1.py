...
class Bill_App:
    def __init__(self,root):
        ...
        lbl_color = 'white'
        #Title of App
        title = Label(self.root,text = "RETAIL BILLING SOFTWARE",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
        ...
        #===========Frame Content
        bath_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Bath Soap Rs.40")
        ...
        #=======Face Cream
        face_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Face Cream Rs.140")
        ...
        #========Face Wash
        wash_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Face Wash Rs.240")
        ...
        #========Hair Spray
        hair_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Hair Spray Rs.340")
        ...
        #============Body Lotion
        lot_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Body Lotion Rs.260")
        ...
        #===========Frame Content
        rice_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Rice Rs.80/kg")
        ...
        #=======
        oil_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Food Oil Rs.180/kg")
        ...
        #=======
        daal_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Daal Rs.80/kg")
        ...
        #========
        wheat_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Wheat Rs.100/kg")
        ...
        #============
        sugar_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Sugar Rs.170/kg")
        ...
        #===========Frame Content
        maza_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Maza Rs.20")
        ...
        #=======
        cock_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Coke Rs.60")
        ...
        #=======
        frooti_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Frooti Rs.50")
        ...
        #========
        cold_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Nimkos Rs.20")
        ...
        #============
        bis_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Biscuits Rs.20")
        ...
        save_btn = Button(F4, text="Save Bill", bg=bg_color, fg=fg_color, font=("lucida", 12, "bold"),
                          bd=7, relief=GROOVE, command=self.save_bill)
        save_btn.grid(row=1, column=8, ipadx=20)
...
#Function For Text Area
    def welcome_soft(self):
        ...
        self.txt.insert(END,"       Welcome To KANISHK Retail\n")
        ...
        self.txt.insert(END,"\n===================================")
    def save_bill(self):
        customer_name = self.cus_name.get()
        phone_number = self.c_phone.get()
        bill_number = self.c_bill_no.get()
        bill_data = self.txt.get("1.0", END)
        self.bill_area()

        # Insert data into the bills table
        self.cursor.execute("INSERT INTO bills (customer_name, phone_number, bill_number, bill_data) VALUES (?, ?, ?, ?)",
                            (customer_name, phone_number, bill_number, bill_data))
        self.conn.commit()
